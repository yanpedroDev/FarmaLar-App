...
fun criaListaMedicamentoDTOsPadroes(): List<MedicamentoDTO> {
    return listOf(
        MedicamentoDTO(
            nome = "Brometo de Ipratrópio 0,02mg",
            descricao = "remedio de asma",
            patologia = "ASMA",
            precisaReceita = true,
            valor = 15,
        ...
        MedicamentoDTO(
            nome = "Brometo de Ipratrópio 0,25mg",
            patologia = "ASMA",
        ...
        MedicamentoDTO(
            nome = "Dipropionato de Beclometasona 200mcg",
            patologia = "ASMA",
            descricao = "GRATUIDADE",
            precisaReceita = true,
            valor = 30,
        ...
        MedicamentoDTO(
            nome = "Dipropionato de Beclometasona 250mcg",
            patologia = "ASMA",
            descricao = "GRATUIDADE",
            precisaReceita = true,
            valor = 35,
        ...
        MedicamentoDTO(
            nome = "Dipropionato de Beclometasona 1mcg",
            patologia = "ASMA",
            descricao = "GRATUIDADE",
            precisaReceita = true,
            valor = 40,
        ...
        MedicamentoDTO(
            nome = "Insulina Humana Regular 100UI/ml",
            patologia = "DIABETES",
            descricao = "GRATUIDADE",
            precisaReceita = true,
            valor = 50,
        ...
        MedicamentoDTO(
            nome = "Besilato de Anlodipino 5mg",
            patologia = "HIPERTENSÃO",
            descricao = "GRATUIDADE",
            precisaReceita = true,
            valor = 12,
        ...
        MedicamentoDTO(
            nome = "Succinato de Metoprolol 25mg",
            patologia = "HIPERTENSÃO",
            descricao = "COPAGAMENTO",
            precisaReceita = true,
            valor = 16,
        ...
        MedicamentoDTO(
            nome = "Etinilestradiol 0,03mg + Levonorgestrel 0,15mg",
            patologia = "ANTICONCEPÇÃO",
            descricao = "COPAGAMENTO",
            precisaReceita = true,
            valor = 30,
        ...
        MedicamentoDTO(
            nome = "Valerato de Estradiol 5mg + Enantato de Noretisterona 50mg",
            patologia = "ANTICONCEPÇÃO",
            descricao = "COPAGAMENTO",
            precisaReceita = true,
            valor = 35,
        ...
        MedicamentoDTO(
            nome = "Carbidopa 25mg + Levodopa 250mg",
        ...
        MedicamentoDTO(
            nome = "Cloridrato de Benserazida 25mg + Levodopa 100mg",
            patologia = "DOENÇA DE PARKINSON",
            descricao = "GRATUIDADE",
            precisaReceita = true,
            valor = 45,
